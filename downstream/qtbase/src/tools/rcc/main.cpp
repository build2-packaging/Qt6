...
int main(int argc, char *argv[])
{
    ...
    {
      printf ("# build2 buildfile qt6rcc\n");
      printf ("export.metadata = 1 qt6rcc\n");
      printf ("qt6rcc.name = [string] rcc\n");
      printf ("qt6rcc.version = [string] '%s'\n", QT_VERSION_STR);
      printf ("qt6rcc.checksum = [string] '%s'\n", QT_VERSION_STR);
