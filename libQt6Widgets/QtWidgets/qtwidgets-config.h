...
#  define QT_NO_BUTTONGROUP 1
#endif

#define QT_FEATURE_calendarwidget 1
#if !QT_CONFIG(calendarwidget)
#  define QT_NO_CALENDARWIDGET 1
#endif
...
#  define QT_NO_RESIZEHANDLER 1
#endif

#define QT_FEATURE_rubberband 1
#if !QT_CONFIG(rubberband)
#  define QT_NO_RUBBERBAND 1
#endif

#define QT_FEATURE_scrollarea 1
#if !QT_CONFIG(scrollarea)
#  define QT_NO_SCROLLAREA 1
#endif

#define QT_FEATURE_scrollbar 1
#if !QT_CONFIG(scrollbar)
#  define QT_NO_SCROLLBAR 1
#endif
